...
<petclinic:layout pageName="restaurant">
    ...
    <form:form modelAttribute="restaurant" class="form-horizontal" id="add-restaurant-form">
        ...
        <div class="form-group has-feedback">
            ...
            <span class="input-group" style="margin-left: 5%;">ContraseÃ±a: </span><input label="Password" required type="password" class="form-control" style="width: 90%; margin-left: 5%;" name="user.password"/><br/>
            ...
            <span class="input-group" style="margin-left: 5%;">DirecciÃ³n de correo: </span><input label="Email" required type="email" class="form-control" style="width: 90%; margin-left: 5%;" name="email"/><br/>
            ...
            <span class="input-group" style="margin-left: 5%;">DirecciÃ³n: </span><input label="Address" required type="text" class="form-control" style="width: 90%; margin-left: 5%;" name="address"/><br/>
            <span class="input-group" style="margin-left: 5%;">DescripciÃ³n: </span><input label="Description" required minlength="25" maxlength="250" class="form-control" style="width: 90%; margin-left: 5%;" name="description"/><br/>
            ...
            <div class="col-sm-12" style="text-align: center; margin-top: 5px;">
                <c:choose>
                    <c:when test="${restaurant['new']}">
                        <button class="buton-detalles-listado" type="button" style="text-decoration: none; color: #ffff; font-size: 14px;">AÃ±adir restaurante</button>
                    </c:when>
                </c:choose>
            </div>
        </div>
