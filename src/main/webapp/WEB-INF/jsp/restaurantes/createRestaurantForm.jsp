...
<petclinic:layout pageName="restaurant">
    ...
    <form:form modelAttribute="restaurant" class="form-horizontal" id="add-restaurant-form">
        <div class="form-group has-feedback">
            ...
            <span>Contrase�a: </span><input label="Password" required type="password" name="user.password"/><br/>
            <span>Nombre: </span><input label="Name" required type="text" minlength="3" maxlength="50" name="name"/><br/>
            <span>Direcci�n de correo: </span><input label="Email" required type="email" name="email"/><br/>
            ...
            <span>Direcci�n: </span><input label="Address" required type="text" name="address"/><br/>
            <span>Descripci�n: </span><input label="Description" required minlength="25" maxlength="250" name="description"/><br/>
